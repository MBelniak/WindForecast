...
experiment.dropout=0.7 optim.base_lr=0.00045 experiment.lstm_hidden_state=256 experiment.lstm_num_layers=2 \
experiment.use_time2vec=False experiment.use_value2vec=False \
experiment.regressor_head_dims=[128,128,64] experiment.epochs=20 experiment.num_workers=16 experiment.target_coords=[51.564747,21.542751] experiment.synop_file="KOZIENICE_351210488_data.csv" experiment.sequence_length=48

python -m wind_forecast.main experiment=hybrid_bi_lstm_s2s_gfs optim=adam experiment.target_parameter=wind_velocity \
experiment.dropout=0.7 optim.base_lr=0.00045 experiment.lstm_hidden_state=256 experiment.lstm_num_layers=2 \
experiment.use_time2vec=False experiment.use_value2vec=False \
experiment.regressor_head_dims=[128,128,64] experiment.epochs=20 experiment.num_workers=16 experiment.target_coords=[51.564747,21.542751] experiment.synop_file="KOZIENICE_351210488_data.csv"
...
experiment.regressor_head_dims=[64,32] experiment.epochs=20 experiment.num_workers=16 experiment.target_coords=[51.564747,21.542751] experiment.synop_file="KOZIENICE_351210488_data.csv"

python -m wind_forecast.main experiment=transformer_encoder_s2s_gfs optim=adam experiment.target_parameter=temperature \
experiment.dropout=0.7 optim.base_lr=0.008 experiment.transformer_ff_dim=512 \
experiment.transformer_encoder_layers=6 experiment.use_time2vec=False experiment.use_value2vec=False \
experiment.regressor_head_dims=[64,32] experiment.epochs=20 experiment.num_workers=16 experiment.target_coords=[51.564747,21.542751] experiment.synop_file="KOZIENICE_351210488_data.csv" experiment.sequence_length=48
...
#GFS
python -m wind_forecast.main experiment=gfs experiment.target_parameter=temperature experiment.target_coords=[51.564747,21.542751] experiment.synop_file="KOZIENICE_351210488_data.csv"

python -m wind_forecast.main experiment=gfs experiment.target_parameter=wind_velocity experiment.target_coords=[51.564747,21.542751] experiment.synop_file="KOZIENICE_351210488_data.csv"

python -m wind_forecast.main experiment=gfs experiment.target_parameter=pressure experiment.target_coords=[51.564747,21.542751] experiment.synop_file="KOZIENICE_351210488_data.csv"
...
experiment.target_coords=[51.564747,21.542751] experiment.synop_file="KOZIENICE_351210488_data.csv"
