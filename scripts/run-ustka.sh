...
experiment.dropout=0.06 optim.base_lr=0.00005 experiment.lstm_hidden_state=1024 experiment.lstm_num_layers=2 \
experiment.use_time2vec=False experiment.use_value2vec=False \
experiment.regressor_head_dims=[64,128,32] experiment.epochs=20 experiment.num_workers=16 experiment.target_coords=[54.5884822,16.8542177] experiment.synop_file="USTKA_354160115_data.csv" experiment.sequence_length=48

python -m wind_forecast.main experiment=lstm_s2s optim=adam experiment.target_parameter=wind_velocity \
experiment.dropout=0.06 optim.base_lr=0.00005 experiment.lstm_hidden_state=1024 experiment.lstm_num_layers=2 \
experiment.use_time2vec=False experiment.use_value2vec=False \
experiment.regressor_head_dims=[64,128,32] experiment.epochs=20 experiment.num_workers=16 experiment.target_coords=[54.5884822,16.8542177] experiment.synop_file="USTKA_354160115_data.csv"
